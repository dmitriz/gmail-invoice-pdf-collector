...
const run = async (options = {}) => {
  try {
    ...
    logger.info(`Downloaded ${results.downloadedPdfs} PDFs from ${results.pdfAttachments} PDF attachments`);
...
// If this file is executed directly, run with default config
